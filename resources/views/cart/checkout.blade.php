            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="country" name="country" 
                                        class="w-full px-4 py-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent" required>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow p-6 sticky top-4">
                        ...
                        <div class="space-y-3 mb-6">
                            @foreach(cartItems() as $item)
                                <div class="flex justify-between text-sm">
                                    <span class="text-gray-600">{{ $item['name'] }} - Ch. {{ $item['chapter'] }} (x{{ $item['quantity'] }})</span>
                        ...
                        <a href="{{ route('cart') }}" class="block text-center mt-4 text-sm text-gray-600 hover:text-gray-900">
                            ← Back to Cart
                        </a>
                    </div>
                </div>
