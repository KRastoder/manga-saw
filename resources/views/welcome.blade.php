...
<div class="w-full max-w-7xl mx-auto px-6 py-16 relative bg-[#F4F2EE]">
    ...
    <div class="relative">
        ...
        @foreach ($latestMangas as $index => $manga)
            <input type="radio" name="carousel" id="slide-{{ $index }}" class="hidden" {{ $index === 0 ? 'checked' : '' }}>
        @endforeach
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-10">
            ...
            <a href="#"
               class="group relative block">
                ...
                <div class="absolute left-0 right-0 bottom-5 h-[25%] bg-[#101211] flex items-center justify-center
